...
public class StationInfoBoxManager : MonoBehaviour//, IInfoBoxHoverHandler
{
    ...
    //     routeResourceCost.text = $"Route cost: {station.availableRoutes[0].resourceCost:N0} tonne-kms";
    //     distanceText.text = $"Distance: {station.availableRoutes[0].distance:N0} km";
    //     
