...
namespace Train.View.YardView
{
    public class YardMarshallView : MonoBehaviour
    {
        ...
        private readonly Dictionary<RollingStockModel, RollingStockView> _modelToView = 
            new Dictionary<RollingStockModel, RollingStockView>();
        ...
        private void AddNewRollingStock(IReadOnlyList<RollingStockModel> newConsist)
        {
            foreach (var model in newConsist)
            {
                ...
                var prefab = RollingStockRepository.I.GetRollingStockViewPrefab(model);
